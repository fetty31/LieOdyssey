#ifndef __LIDAR_ODOMETRY_ROS_COMMON_HPP__
#define __LIDAR_ODOMETRY_ROS_COMMON_HPP__
...
POINT_CLOUD_REGISTER_POINT_STRUCT(lidar_odometry_ros::Point,
                                 (float, x, x)
                                 (float, y, y)
                                 (float, z, z)
...
typedef lidar_odometry_ros::Point PointType;
...
typedef std::vector<lidar_odometry_ros::Match> Matches;
typedef std::vector<lidar_odometry_ros::State> States;
