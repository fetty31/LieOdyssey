...
// Fill Measurement Jacobian H with point-to-plane residual derivative 
Eigen::Matrix<Scalar, 1, 10> fill_H_point_to_plane(const Group& group, const V3& normal, const V3& point);
