...
typename Filter::Tangent gilda_lio::iESEKF::f(const Filter& kf, const lie_odyssey::IMUmeas& imu) 
{
...
typename Filter::Jacobian gilda_lio::iESEKF::df_dx(const Filter& kf, const lie_odyssey::IMUmeas& /*imu*/) 
{
	// IMU kinematic integration (body-centric):
	// R ⊞ (w - bw - nw)*dt
	// v ⊞ ((a - ba - na) + Rt*g)*dt
...
typename Filter::MappingMatrix gilda_lio::iESEKF::df_dw(const Filter& /*kf*/, const lie_odyssey::IMUmeas& /*imu*/) 
{
