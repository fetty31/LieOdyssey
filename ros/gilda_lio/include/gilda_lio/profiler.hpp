...
#ifndef GILDA_PROFILE
#define GILDA_PROFILE 0
#endif
...
#define GILDA_CONCAT_IMPL(x, y) x##y
#define GILDA_CONCAT(x, y) GILDA_CONCAT_IMPL(x, y)

#define GILDA_PROFILE_SCOPE(profiler, name) \
    gilda_lio::ScopedTimer GILDA_CONCAT(_prof_, __LINE__)(profiler, name)

#define GILDA_PROFILE_FUNCTION(profiler) \
    GILDA_PROFILE_SCOPE(profiler, __FUNCTION__)
